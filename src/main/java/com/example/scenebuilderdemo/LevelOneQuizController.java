...
public class LevelOneQuizController {
    ...
    private boolean checkAnswer(String answer) { // Method which checks if the selected answer is correct
        String[] correctAnswers = {"4 out of 10", "50%", "60% to 80%", "Ensures that the population has access to safe water supply and sanitation services"}; // Array containing the correct answers for each question
