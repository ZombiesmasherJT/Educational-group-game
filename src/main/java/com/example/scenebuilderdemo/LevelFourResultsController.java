...
/**
 * This class is responsible for generating the results page for level four.
 * @author Tedi Mengjezi
 */
public class LevelFourResultsController {
    @FXML
    ...
    private void initialize() {
        correct = LevelFourQuizController.correct;
        wrong = LevelFourQuizController.wrong;
